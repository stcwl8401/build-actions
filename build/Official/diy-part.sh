...
# 后台IP设置
export Ipv4_ipaddr="192.168.31.6"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="OpenWrt by stcwl"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export DNS_Settings="192.168.31.3"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
...
export Customized_Information="官改自用"  # 个性签名,你想写啥就写啥，(填0为不作修改)
